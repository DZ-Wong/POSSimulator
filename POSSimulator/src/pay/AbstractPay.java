...
public abstract class AbstractPay <R extends Map, S extends String> {
    ...
    public S handle(
        ...
        logger.info(genericRequest.toString()); 
    ...
    protected String sign(GenericRequest request) {
        GenericRequest response = new GenericRequest();;
        String privateKey ="MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAJxhz1eAhBR"
                + "2P764OeHLXI+muyN9weGN2GBfWbMSkR0bI6pYZNUwCMxEn8tzcHkm2lkjOBTVDCtrwSE"
                + "WJ8CUz9qe7lDo6DpDKHN6H+vZ7hTLtHt129sujDANQ+3vd9YX/E9Yjt8ShdcUKFQZO2k"
                + "xGl74nUhGAO3xENV0U5/EKyvFAgMBAAECgYBGEKCoUMFctZpb5giw/L9s8UP5Y9fhKf9"
                + "fNnlm/ROdWdKB+Pa8ebgHZVu++OrUrS65L0lqNAYu0imGnHmVFFeHpY5NSI80AwE7Gjq"
                + "+WYOlN3IhMdWUk+9r/QzQ7vddmWVxQsX7pluFFjSmGel4B4VntPKQufL9Ada3aXa/xBC"
                + "6hQJBANMgNO7K8fBFDyvqk9SjDHqVCQ2H2jgdDG4uTJRvcKwfb87UOOm1cnu1oQ1x35c"
                + "pfKU/ozgglM7JHg6m6dLwXLMCQQC9nuIAIDlwh2TMZpAsiyr0Wv9BJjyrvAKrlqVpXQM"
                + "3/w+t70mTP1lOt+dgx0wgqdgYiAK0D7LQPexi6NTH9gGnAkEAoQTcOg8gLG6PHqBetPr"
                + "RpqAJ8n7dKJTHCTVYhJDlrvCe9nCXI2+Wa9FfjoB91az3epSpaEI5G+j5epVEmfNlzwJ"
                + "AdwDBwWZ35gFy5zzu+qWUnaqGS7LdnMHvwxRWV1vCa2AtzPFB8aFuQRL1qS0qv80YC71"
                + "ARRUdGcfjFOgesifYPQJBAIjMECgpygLcUGdz3bjVQ5ru0K3Ed/70xio3vObLOko3Z4Y"
                + "fCFu7LtjVFv2NSfM9gfPzT7BY97LkKXUQviFZJ1U=";
